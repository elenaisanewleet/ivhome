...
export const MVP_SERVICE_CATALOG: OfferService[] = [
  ...
  },
  {
    ...
    shortLabel: "Вывод из запоя",
    priceRange: "от 11 000 ₽",
    description: "Формат, назначения и возможность выезда подтверждает выбранная медслужба.",
  },
  {
    slug: "intoxication",
    label: "Детокс",
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: [
      "Надом — это подбор медслужбы. Сами услугу, формат и стоимость подтверждает выбранная медслужба.",
...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: "Кто приедет?",
    a: "Специалист выбранной вами организации. Показываем варианты с проверенной лицензией.",
  },
  {
    q: "Сколько это стоит?",
  ...
  },
  {
    ...
    a: "У каждой медслужбы видно отдельно: Ответ медслужбы и Прибытие после подтверждения. Точное время прибытия подтверждает выбранная медслужба.",
  },
];
...
export const TIME_OPTIONS = ["Как можно скорее", "Сегодня", "Ночью", "Завтра", "Выбрать время"];
