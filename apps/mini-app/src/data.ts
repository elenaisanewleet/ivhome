...
export const STEPS: Step[] = [
  {
    id: "welcome",
    eyebrow: "анонимно · быстро · удобно",
...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    q: "Это скорая помощь?",
    a: "Нет. Надом подбирает медслужбу для планового или срочного выезда на дом. При острых симптомах звоните 103 или 112 — это быстрее.",
  },
  {
    q: "Кто приедет?",
    a: "Специалист выбранной вами медслужбы. Показываем медслужбы с проверенной лицензией.",
  },
  {
    q: "Сколько это стоит?",
    a: "Ориентир по стоимости видно ещё до заявки. Итоговую сумму подтверждает медслужба перед выездом.",
  },
  {
    q: "Это анонимно?",
    a: "Для подбора хватает района и времени — без точного адреса и звонков. Данные для выезда медслужба запросит только после того, как вы подтвердите заявку.",
  },
  {
    q: "Как быстро приедут?",
    a: "У каждой медслужбы видно, когда ответят и когда приедут. Точное время прибытия подтверждает медслужба.",
  },
];
