...
export const MVP_SERVICE_CATALOG: OfferService[] = [
  {
    ...
    description: "Нейтральный запрос на выезд. Детали и стоимость подтверждает выбранная организация.",
  },
  {
    ...
    description: "Седативные препараты — только по решению специалиста выбранной организации и в рамках лицензии.",
  },
  {
    slug: "intoxication",
    ...
    description: "Выбранная организация сама подтвердит возможность выезда и формат помощи.",
  },
  {
    slug: "urgent_visit",
  ...
  },
  {
    ...
    priceRange: "от 5 500 ₽",
    description: "Плановый выезд в удобное время после подтверждения выбранной организации.",
  },
  {
    slug: "custom",
    label: "Свой запрос",
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: [
      "Надом — это подбор медицинской организации. Сами медицинские услуги оказывает выбранная организация.",
  ...
  },
  {
    ...
    body: [
      ...
      "Если всё спокойно — продолжайте подбор. Возможность выезда подтверждает выбранная организация.",
    ],
    iconLabel: "signal",
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "Время прибытия отдельно подтвердит выбранная организация.",
    ],
    iconLabel: "time",
  },
  {
...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: "Сколько это стоит?",
    a: "Ориентир по стоимости видно ещё до заявки. Итоговую сумму подтверждает выбранная организация перед выездом.",
  },
  {
    q: "Какие данные нужны?",
    a: "Для подбора хватает района и времени — без точного адреса и звонков. Данные для выезда выбранная организация запросит только после того, как вы подтвердите заявку.",
  },
  {
    q: "Как быстро приедут?",
    a: "У каждой организации видно, когда ответят и когда приедут. Точное время прибытия подтверждает выбранная организация.",
  },
];
