...
This is responsibility-framing guidance, not a broad ban on medical service wording. Medical wording is allowed when it is clear that Nadom helps the user choose a clinic / medservice; the selected clinic / medservice confirms the service, procedure format, prescriptions, composition where applicable, final price, and visit possibility; and Nadom itself is not framed as the clinic, doctor, prescriber, or medical provider. If copy triggers one of these review points, rewrite it calmly instead of adding a broader banned-word list.
