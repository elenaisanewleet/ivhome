...
The current Tone of Voice is calm, private, concise, useful, and Telegram-native. Public-facing copy should be checked for responsibility framing: medical service wording is allowed when it is clear that Nadom helps the user choose a clinic / medservice, and the selected clinic / medservice confirms the service, procedure format, prescriptions, composition where applicable, final price, and visit possibility. Nadom itself must not be framed as the clinic, doctor, prescriber, or medical provider. Do not turn this review guidance into a broader banned-word list.
